...
There are currently **`r length(current_members$city)`** active members/followers in our meetup page. They are from  the **`r length(city_members$city)`** cities around the world shown here after. 
